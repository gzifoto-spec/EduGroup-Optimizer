...
export default function CompatibilityPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">{t('nav.compatibility')}</h1>
        <p className="text-muted-foreground mt-1 text-sm">{t('pages.compatibility.description')}</p>
      </div>
